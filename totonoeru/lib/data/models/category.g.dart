...
const CategorySchema = CollectionSchema(
  ...
  properties: {
    ...
    r'iconIdentifier': PropertySchema(
      id: 2,
      name: r'iconIdentifier',
      type: IsarType.string,
    ),
...
int _categoryEstimateSize(
  ...
  bytesCount += 3 + object.iconIdentifier.length * 3;
  bytesCount += 3 + object.name.length * 3;
  bytesCount += 3 + object.nameJp.length * 3;
...
void _categorySerialize(
  ...
  writer.writeString(offsets[2], object.iconIdentifier);
  writer.writeBool(offsets[3], object.isSystem);
  writer.writeString(offsets[4], object.name);
  writer.writeString(offsets[5], object.nameJp);
...
Category _categoryDeserialize(
  ...
  object.iconIdentifier = reader.readString(offsets[2]);
  object.id = id;
  object.isSystem = reader.readBool(offsets[3]);
  object.name = reader.readString(offsets[4]);
  object.nameJp = reader.readString(offsets[5]);
...
extension CategoryQueryFilter
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> iconIdentifierEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'iconIdentifier',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> iconIdentifierBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition>
      iconIdentifierContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'iconIdentifier',
        value: value,
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> iconIdentifierMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> isSystemEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isSystem',
...
extension CategoryQuerySortBy on QueryBuilder<Category, Category, QSortBy> {
  ...
  QueryBuilder<Category, Category, QAfterSortBy> sortByIconIdentifier() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'iconIdentifier', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> sortByIconIdentifierDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'iconIdentifier', Sort.desc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> sortByIsSystem() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSystem', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> sortByIsSystemDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryQuerySortThenBy
  ...
  QueryBuilder<Category, Category, QAfterSortBy> thenByIconIdentifier() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'iconIdentifier', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> thenByIconIdentifierDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'iconIdentifier', Sort.desc);
    });
  }
  ...
  QueryBuilder<Category, Category, QAfterSortBy> thenByIsSystem() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSystem', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> thenByIsSystemDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSystem', Sort.desc);
    });
  }
...
extension CategoryQueryWhereDistinct
  ...
  QueryBuilder<Category, Category, QDistinct> distinctByIconIdentifier(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'iconIdentifier',
          caseSensitive: caseSensitive);
    });
  }

  QueryBuilder<Category, Category, QDistinct> distinctByIsSystem() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryQueryProperty
  ...
  QueryBuilder<Category, String, QQueryOperations> iconIdentifierProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'iconIdentifier');
    });
  }

  QueryBuilder<Category, bool, QQueryOperations> isSystemProperty() {
    return QueryBuilder.apply(this, (query) {
